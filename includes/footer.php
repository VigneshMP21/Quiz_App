        ...
        <section class="app-site-footer-brand">
            <div class="app-site-footer-logo">
                ...
                <div>
                    ...
                    <p><?php echo htmlspecialchars($pageFooterSummary ?? 'A sharper interface for quizzes, certificates, collaboration, and platform flow.'); ?>
                    </p>
                </div>
            </div>
        </section>
        ...
        <section class="app-site-footer-column">
            ...
            <div class="app-site-footer-meta">
                <span><i class="fas fa-user-shield"></i>
                    <?php echo $isAdminView ? 'Admin access enabled' : 'Learner access enabled'; ?></span>
                <span><i class="fas fa-bell"></i> <?php echo (int) ($notificationCount ?? 0); ?> active
                    notification<?php echo ((int) ($notificationCount ?? 0) === 1) ? '' : 's'; ?></span>
